...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-^l_7dx#dh_b$t2#6)*3wj5rfmjk!kzqqk=t3ia17&*s41#+nk6')
...
# Ensure WhiteNoise serves static files in development too
